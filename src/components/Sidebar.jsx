            ...
            <nav>
                <ul>
                    <li className="mb-2">
                        ...
                        >
                            <img src="public\assets\home.svg" alt="Logo Home" className="w-6 h-6 mr-2" style={{ filter: 'invert(1)' }} />
                            <span>Dashboard</span>
                        </NavLink>
                    </li>
                    <li className="mb-2">
                        ...
                        >
                            <img src="public\assets\book-bookmark-fill.svg" alt="Logo Panduan" className="w-6 h-6 mr-2" style={{ filter: 'invert(1)' }} />
                    ...
                    <li className="mb-2">
                        ...
                        >
                            <img src="public\assets\checklist.svg" alt="Logo Presensi" className="w-6 h-6 mr-2" style={{ filter: 'invert(1)' }} />
                            <span>Presensi</span>
                        </NavLink>
                    </li>
                    {user.role === 'admin' && (
                        <li className="mb-2">
                            ...
                            >
                                <img src="public\assets\user.svg" alt="Logo Santri" className="w-6 h-6 mr-2" style={{ filter: 'invert(1)' }} />
                                <span>Santri</span>
                            </NavLink>
                        </li>
                    )}
